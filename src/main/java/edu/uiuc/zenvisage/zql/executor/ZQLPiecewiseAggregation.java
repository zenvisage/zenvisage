...
public class ZQLPiecewiseAggregation {
	 ...
	 */
	public ZQLPiecewiseAggregation(Normalization normalization, Database inMemoryDatabase) {
	...
	public double[][] applyPAAonData(LinkedHashMap<String, LinkedHashMap<Float, Float>> data, Set<Float> ignore,
			String x) {
